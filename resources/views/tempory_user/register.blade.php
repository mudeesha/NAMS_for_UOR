...
<head>
  <meta charset="utf-8">
    ...
    <title>UOR Non Academic Management System - Sign Up</title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="container h-p80">
        ...
        <img src="{{asset('backend/images/logo2.png')}}">
         </div>	
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">University of Ruhuna</h2>
                            <h3 class="text-white">Non Academic Management System</h3>
                             ...
                             @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="l_name" name="l_name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Last Name">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="sur_name" name="sur_name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Surname">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="number" id="contact_no" name="contact_no" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Contact Number">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="address_line_1" name="address_line_1" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Address Line 1">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="address_line_2" name="address_line_2" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Address Line 2">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="number" id="postal_code" name="postal_code" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Postel Code">
									</div>
								</div> -->
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<label for="membership">District:</label>
