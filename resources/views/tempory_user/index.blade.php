				...
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<a href="{{route('temp_user.application')}}"><p class="text-mute mt-20 mb-0 font-size-16">Submit Application</p></a>
				...
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
							<a href="{{route('temp_user.upload')}}"><p class="text-mute mt-20 mb-0 font-size-16">Submit Documents</p></a>
								<h3 class="text-white mb-0 font-weight-500">3400 <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Notieses</p>
