...
<head>
  <meta charset="utf-8">
    ...
    <title>UOR Non Academic Management System - Log in </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							...
							<p class="text-white-50">Sign in to start your account</p>							
						</div>
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account Testeee? <a href="" class="text-info ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
